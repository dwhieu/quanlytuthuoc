...
const PatientsPage: React.FC = () => {
    ...
    useEffect(() => {
        (window as any).__patientsAuthToken = token;
    }, [token]);
    ...
    // Xuất danh sách bệnh nhân đang hiển thị ra file CSV
    const handleExport = () => {
        ...
        link.href = url;
        const fileName = `danh-sach-benh-nhan-${new Date().toISOString().split('T')[0]}.csv`;
    ...
    return (
        <div className="patients-page">
            ...
            <div className="action-buttons">
                ...
                <Button variant="success" onClick={handleExport}>Xuất danh sách</Button>
                    ...
                    {filteredPatients.map((patient, index) => (
                        <tr key={patient.id} data-patient-id={patient.id}>
                            ...
                            <td className="action-icons">
                                ...
                                <span className="icon-delete" title="Xóa" onClick={() => handleDelete(patient.id)}>
                                    <FaTrashIcon />
                                </span>
                            </td>
                        </tr>
        ...
        if (submitBtn) {
            submitBtn.addEventListener('click', async (event) => {
                ...
                try {
                    ...
                    const token = (window as any).__patientsAuthToken;
