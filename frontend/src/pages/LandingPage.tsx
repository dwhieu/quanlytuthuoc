...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="landing-page">
      ...
      {/* Features Section */}
      <section ref={featuresRef} className="features-section fade-in-section">
        <div className="container-landing">
          ...
          <div className="features-list">
            <div className="feature-row">
              ...
              <div className="feature-visual">
                <img
                  src="/images/feature-inventory.svg"
                  alt="Minh họa quản lý kho thuốc"
            ...
            <div className="feature-row feature-row-reverse">
              ...
              <div className="feature-visual">
                <img
                  src="/images/feature-patient.svg"
                  alt="Minh họa quản lý bệnh nhân"
                  className="feature-image"
                />
              </div>
            </div>
            ...
            <div className="feature-row">
              ...
              <div className="feature-visual">
                <img
                  src="/images/feature-report.svg"
                  alt="Minh họa thống kê và báo cáo"
                  className="feature-image"
                />
              </div>
            </div>
